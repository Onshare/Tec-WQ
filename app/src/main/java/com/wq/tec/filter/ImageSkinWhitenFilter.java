...
public class ImageSkinWhitenFilter extends GPUImageFilter {
    ...
    public ImageSkinWhitenFilter(int[] mTextSize) {
    ...
    public void onInputSizeChanged() {
        GLES20.glUniform1f(mTexelWidthUniformLocation, (1.0f / mTextSize[0]));
        GLES20.glUniform1f(mTexelHeightUniformLocation, (1.0f / mTextSize[1]));
    }
